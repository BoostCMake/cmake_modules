...
function(add_subdirectories INPUT_DIRECTORY)
    ...
    foreach(lib ${LIBS})
        ...
        if(PARSE_SUBMODULE_DEFINITION_HEADER)
            set(SUBMODULE_HEADER ${PARSE_SUBMODULE_DEFINITION_HEADER})
...
function(cm_project INPUT_PROJECT_NAME)
    ...
    if(PARSE_WORKSPACE_NAME)
        project(${PARSE_WORKSPACE_NAME}_${INPUT_PROJECT_NAME} ${PARSE_VERSION} ${PARSE_DESCRIPTION} ${PARSE_LANGUAGES})
    else()
